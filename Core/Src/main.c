...
#define IR_PID_I           0.90f
#define IR_PID_D           0.90f
...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
uint16_t Current_Original = 0; // 原始电流
uint16_t Voltage_Original = 0; // 原始电压
uint16_t Pow_Original     = 0; // 原始功率

float Current = 0; // 转换后电流
float Voltage = 0; // 转换后电压
float Pow     = 0; // 转换后功率

float Goal_Pow = GOAL_POW; // 目标功率
