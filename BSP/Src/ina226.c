...
void INA226_Init(void)
{
    ...
    tData[2] = HAL_I2C_Master_Transmit(&I2C_HANDLE, INA226_ADDR, tData, 3, 0xff);
    HAL_Delay(5);
...
uint16_t INA226_Read_Bus_Voltage(void)
{
    ...
    HAL_I2C_Master_Transmit(&I2C_HANDLE, INA226_ADDR, tData, 1, 0xff);
    HAL_I2C_Master_Receive(&I2C_HANDLE, INA226_ADDR, rData, 2, 0xff);
